      ...
      <main className="relative z-10 mx-auto grid max-w-screen-2xl items-center gap-10 px-5 pb-24 pt-14 lg:grid-cols-[0.9fr_1.1fr] lg:px-6">
        ...
        >
          <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-[#1f1f1f] px-4 py-2">
            ...
            <span className="text-xs font-bold uppercase tracking-[1.6px] text-[#b3b3b3]">Effortless splitting</span>
          </div>
          <h2 className="mb-6 max-w-2xl text-5xl font-black leading-none tracking-tight lg:text-7xl">
            Stop stressing over <span className="text-[#1ed760]">expenses.</span>
          </h2>
          <p className="mb-10 max-w-lg text-base font-normal leading-6 text-[#b3b3b3]">
            Keep track of shared costs, settle up with ease, and manage group finances in multiple currencies.
          </p>
          <SignInButton mode="modal">
          ...
          <div className="mt-12 flex items-center gap-6 border-t border-[#2a2a2a] pt-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-bold uppercase tracking-[1.6px] text-[#b3b3b3]">Secure Login</span>
            </div>
            <div className="flex items-center gap-2">
              <Globe size={20} className="text-[#b3b3b3]" />
              <span className="text-[10px] font-bold uppercase tracking-[1.6px] text-[#b3b3b3]">Multi-currency</span>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="relative z-10 rounded-lg bg-[#181818] p-5 shadow-[rgba(0,0,0,0.5)_0px_8px_24px] lg:p-6">
            <div className="mb-8 flex items-center justify-between">
              <h3 className="text-2xl font-black tracking-tight">Trip to Tokyo</h3>
              <span className="rounded-full bg-[#1ed760] px-3 py-1 text-[10px] font-black uppercase tracking-[1.6px] text-black">JPY ¥</span>
            </div>

            <div className="space-y-2">
              {[
                { name: 'Dinner at Shibuya', amount: '¥12,400', payer: 'Alex', color: 'bg-[#1f1f1f] text-white' },
                { name: 'Train Tickets', amount: '¥3,200', payer: 'Sarah', color: 'bg-[#1f1f1f] text-white' },
                { name: 'Hotel Booking', amount: '¥45,000', payer: 'You', color: 'bg-[#1ed760] text-black' },
              ].map((item) => (
                <div key={item.name} className="flex items-center justify-between rounded-md bg-[#1f1f1f] p-4 hover:bg-[#252525]">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs font-normal text-[#b3b3b3]">Paid by {item.payer}</p>
                    </div>
                  </div>
            ...
            <div className="mt-8 flex items-center justify-between border-t border-[#2a2a2a] pt-6">
              <div>
                <p className="mb-2 text-[10px] font-bold uppercase tracking-[1.6px] text-[#b3b3b3]">You are owed</p>
